      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex flex-col md:flex-row items-center gap-8 lg:gap-12">
          <div className="md:w-1/2 relative group aspect-[4/3]">
            <div className="overflow-hidden rounded-2xl shadow-md group-hover:shadow-xl transition-all duration-300 group-hover:border-orange-400 border border-gray-100">
              <Image
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-orange-400/20 via-orange-400/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          </div>
          ...
          <div className="md:w-1/2 space-y-6 px-4 sm:px-0">
            ...
            >
              <span className="text-lg font-medium font-sans">Discover Youth Programs</span>
