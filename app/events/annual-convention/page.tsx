    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-gray-50 to-white py-12 lg:py-16">
      <div className="container mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <section className="mb-20 max-w-2xl mx-auto text-center">
          ...
          <article className="group relative rounded-2xl border border-gray-100 bg-gradient-to-br from-white to-orange-50 p-10 shadow-md transition duration-300 hover:shadow-2xl hover:-translate-y-1 hover:scale-105 hover:border-orange-400">
            ...
            {[
              {
                ...
                desc: "Dynamic speakers weaving biblical insights with practical wisdom to ignite your spiritual journey.",
              },
              {
                icon: FaMusic,
                title: "Powerful Worship",
                desc: "Lift your voice alongside our worship team and guest artists in perfect harmony.",
              },
              {
                icon: FaUsers,
                title: "Breakout Sessions",
                desc: "Workshops on prayer, leadership, family, and outreach,crafted for every stage of faith.",
              },
              {
                icon: FaChild,
                title: "Youth & Children’s Programs",
                desc: "Faith-growing activities tailored for kids and teens, nurturing the next generation.",
              },
            ].map(({ icon: Icon, title, desc }) => (
              <article
                key={title}
                className="group rounded-2xl border border-gray-100 bg-gradient-to-br from-white to-orange-50 p-10 shadow-md transition duration-300 hover:-translate-y-1 hover:scale-105 hover:border-orange-400 hover:shadow-2xl"
              >
                <div className="mb-6 flex flex-col items-center">
                  <div className="mb-4 rounded-full bg-orange-50 p-4 transition-colors duration-300 group-hover:bg-gray-100">
